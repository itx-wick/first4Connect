    ...
    <Pressable
      ...
      <View style={Styles.test_detail_list_item_row_1}>
        <AppText
          ...
          style={{fontWeight: 'bold', fontSize: RFValue(12)}}
        />
        <AppText
      ...
      <View style={Styles.test_detail_list_item_row_1}>
        <View style={Styles.test_detail_list_item_row_1_col}>
          <AppText children={'Total Marks'} style={{fontSize: RFValue(11)}} />
          <AppText children={exam.TotalMarks} style={{fontSize: RFValue(11)}} />
        </View>
        <View style={Styles.test_detail_list_item_row_1_col}>
          <AppText children={'Pass Marks'} style={{fontSize: RFValue(11)}} />
          <AppText children={exam.PassMarks} style={{fontSize: RFValue(11)}} />
        </View>
        <View style={Styles.test_detail_list_item_row_1_col}>
          <AppText children={'Obtained'} style={{fontSize: RFValue(11)}} />
          <AppText
        ...
        <View style={Styles.test_detail_list_item_row_1_col}>
          <AppText children={'%'} style={{fontSize: RFValue(11)}} />
          <AppText
        ...
        <View style={Styles.test_detail_list_item_row_1_col}>
          <AppText children={'Status'} style={{fontSize: RFValue(11)}} />
          <AppText
