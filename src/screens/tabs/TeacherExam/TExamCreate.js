...
import {setExamsStudentsData} from '../../../redux/tabs/tabsAction';
...
function TExamCreate(props) {
  ...
  const teacherExams = useSelector(state => state.tabs.teacherExams);
  const examStudentsData = useSelector(state => state.tabs.examStudentsData);
